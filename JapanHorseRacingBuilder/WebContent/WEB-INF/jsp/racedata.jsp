...
<aside class="pc sidebar">
	<section>
			<div>
				<span class="racedata"><%out.print(CodeConvert.valueOf(KeibajoCode.class, raceData.getKeibajoCode()).getContent()); %> <%out.print(raceData.getRaceBango()); %>R</span>
				<h2 class="kyosomei"><%out.print(PckeibaConvert.KyosomeiConvert(raceData.getKyosomeiHondai(), raceData.getKyosoShubetsuCode(), raceData.getKyosoJokenCodeSaijakunen())); %></h2>
				<span class="baba"><%out.print(CodeConvert.valueOf(TrackCode.class, raceData.getTrackCode()).getBaba()); %> <%out.print(raceData.getKyori()); %>m</span>
			</div>
			<ul>
				<li>出馬表</li>
				<li>レース結果</li>
